...
const Nav = () => {
    ...
    return (
        <nav className='shadow-md sticky top-0 bg-white z-50 dark:bg-gray-800 dark:text-white'>
            <div className="navbar container mx-auto">
                ...
                <div className="navbar-end">
                    <div onClick={handleThemeSwitch} className={`w-10 h-10 p-1 rounded-full cursor-pointer mr-5 hidden md:block ${!theme ? 'bg-black text-white' : 'bg-gray-50 text-black'}`}>
                        {theme && <SunIcon />}
                        {!theme && <MoonIcon />}
                    </div>
                    {!user ?
