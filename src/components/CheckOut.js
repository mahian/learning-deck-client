...
const CheckOut = () => {
    const { title, duration, image, price } = useLoaderData();
                ...
                <div class="grid min-h-screen grid-cols-10">
                    <div class="col-span-full py-6 px-4 sm:py-12 lg:col-span-6 lg:py-24">
                        <div class="mx-auto w-full max-w-lg">
                            ...
                            <form action="" class="mt-10 flex flex-col space-y-4">
                                ...
                                <div>
                                    ...
                                    <div class="mr-6 flex flex-wrap">
                                        <div class="my-1">
                                            ...
                                            ><select name="month" id="month" class="cursor-pointer rounded border-gray-300 bg-gray-50 py-3 px-2 text-sm shadow-sm outline-none transition focus:ring-2 focus:ring-primary">
                                                <option value="">Month</option>
                                            </select>
                                        </div>
                                        <div class="my-1 ml-3 mr-6">
                                            <label for="year" class="sr-only">Select expiration year</label
                                            ><select name="year" id="year" class="cursor-pointer rounded border-gray-300 bg-gray-50 py-3 px-2 text-sm shadow-sm outline-none transition focus:ring-2 focus:ring-primary">
                                ...
                                <div><label for="card-name" class="sr-only">Card name</label><input type="text" id="card-name" name="card-name" placeholder="Name on the card" class="mt-1 block w-full rounded border-gray-300 bg-gray-50 py-3 px-4 text-sm placeholder-gray-300 shadow-sm outline-none transition focus:ring-2 focus:ring-primary" /></div>
                            </form>
                            <p class="mt-10 text-center text-sm font-semibold text-gray-500">By placing this order you agree to the <Link to="#" class="whitespace-nowrap text-primary underline hover:text-primary">Terms and Conditions</Link></p>
                            <button type="submit" class="mt-4 inline-flex w-full items-center justify-center rounded bg-primary py-2.5 px-4 text-base font-semibold tracking-wide text-white text-opacity-80 outline-none ring-offset-2 transition hover:text-opacity-100 focus:ring-2 focus:border-gray-100 sm:text-lg">Place Order</button>
                        </div>
                    </div>
                    <div class="relative col-span-full flex flex-col py-6 pl-8 pr-4 sm:py-12 lg:col-span-4 lg:py-24">
                        ...
                        <div>
                            ...
                            <div class="absolute inset-0 h-full w-full bg-gradient-to-t from-primary to-primary opacity-95"></div>
                        </div>
                        <div class="relative">
                            <ul class="space-y-5">
                                <li class="flex justify-between">
                                    <div class="inline-flex">
                                        <img src={image} alt="" class="max-h-16" />
                                        <div class="ml-3">
                                            <p class="text-base font-semibold text-white">{title}</p>
                                            <p class="text-sm font-medium text-white text-opacity-80">for {duration} day</p>
                                        </div>
                                    </div>
                                    <p class="text-sm font-semibold text-white">${price}</p>
                                </li>
                            </ul>
                            <div class="my-5 h-0.5 w-full bg-white bg-opacity-30"></div>
                            <div class="space-y-2">
                                <p class="flex justify-between text-lg font-bold text-white"><span>Total price:</span><span>${price}</span></p>
                        ...
                        <div class="relative mt-10 text-white">
                            ...
                            <p class="mt-1 text-sm font-semibold">support@learningdeck.com <span class="font-light">(Email)</span></p>
