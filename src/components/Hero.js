...
const Hero = () => {
    return (
        <section className='py-5 md:py-[80px] dark:bg-gray-800'>
            <div>
                <div className="">
                    <div className="container flex flex-col items-center px-4 mx-auto text-center lg:pb-56 md:px-10 lg:px-32 dark:text-white">
                        <h1 className="text-5xl font-bold leading-none sm:text-6xl xl:max-w-3xl">Get your best career by practicing with learning deck.</h1>
                        <p className="mt-6 mb-8 text-lg sm:mb-12 xl:max-w-3xl dark:text-gray-200">Outsourcing eLearning development is a wise decision as developing eLearning courses in-house can be complicated and time-consuming. Unsure how to go about it? Wondering what to outsource? Read on to find out. eLearning Design eLearning Outsourcing</p>
